...
export default (bot, uri) => {
  ...
  bot.command('^(sch|schedules?) set [char] [string] > [string]', async message => {
  ...
  bot.command('^(sch|schedules?) [char] [string]$', async message => {
  ...
  bot.command('^(sch|schedules?) unset [char] [word]', async message => {
